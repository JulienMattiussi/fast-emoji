# <img src="icons/icon-48.png" width="32" height="32" alt="icon" /> Fast Emoji — Chrome/Firefox

Extension navigateur pour copier un emoji dans le presse-papier en un clic.
...
5. Sélectionner le dossier `chrome/dist/`
...
4. Sélectionner le fichier `chrome/dist/manifest.json`
